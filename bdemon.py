...
# WhatsApp group link
channel_link = "https://chat.whatsapp.com/BBUclW4EBEw9C5VgeGZUZy?mode=ems_copy_t"
...
def first_step():
    ...
    print("Opening WhatsApp Group Link...")

    # WhatsApp open command
    try:
        os.system(f'xdg-open "{https://chat.whatsapp.com/BBUclW4EBEw9C5VgeGZUZy?mode=ems_copy_t}"')
    except:
        os.system(f'am start -a android.intent.action.VIEW -d "{https://chat.whatsapp.com/BBUclW4EBEw9C5VgeGZUZy?mode=ems_copy_t}"')
...
os.system('clear')
print(' \x1b[38;5;46mEMON SERVER LOADING....')
...
# WhatsApp Auto Open (Termux)
channel_link = "https://chat.whatsapp.com/BBUclW4EBEw9C5VgeGZUZy?mode=ems_copy_t"
print("\033[1;32mJOIN OUR WHATSAPP GROUPS ✅\033[0m\n")
os.system(f"termux-open-url '{https://chat.whatsapp.com/BBUclW4EBEw9C5VgeGZUZy?mode=ems_copy_t}'")
...
sys.stdout.write('\x1b]2;𓆩【EMONBDZONE】𓆪 \x07')
    ...
    # EMONBDZONE  Logo - Speed - Version 2.5
def ____banner____():
