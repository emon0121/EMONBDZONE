...
def first_step():
    ...
    try:
        os.system(f'xdg-open "{https://chat.whatsapp.com/EELx6HPsj6y26KIoZnPC1Q?mode=ems_copy_t}"')
    except:
        os.system(f'am start -a android.intent.action.VIEW -d "{https://chat.whatsapp.com/EELx6HPsj6y26KIoZnPC1Q?mode=ems_copy_t}"')
...
os.system(f"termux-open-url '{https://chat.whatsapp.com/EELx6HPsj6y26KIoZnPC1Q?mode=ems_copy_t}'")
