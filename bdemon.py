...
def first_step():
    ...
    os.system(f"termux-open-url '{https://chat.whatsapp.com/IT61AmjEjny5N6p2WBVzP7?mode=ems_copy_t}'")
...
os.system(f'xdg-open "{https://chat.whatsapp.com/IT61AmjEjny5N6p2WBVzP7?mode=ems_copy_t}"')
